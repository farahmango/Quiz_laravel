                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('user.store')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="password" type="password" class="form-control cc-number identified visa" >
                                            </div>
                                            <div class="form-group">
                                                <label  class="control-label mb-1">Role Type</label>
                                                <input name="user_type" type="text" class="form-control cc-number identified visa" >
                                            </div>
                                            <div>
